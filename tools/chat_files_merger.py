...
Merges all extracted ChatGPT conversation files from Cortex-P-Rev directory
"""
...
def merge_extracted_chat_files():
    ...
    # Define the source directory for extracted chats
    source_dir = "/Users/sunghkim37/Library/CloudStorage/GoogleDrive-britkenko@gmail.com/My Drive/PACO/Cortex-P-Rev/extracted_chats"
    
    # Output file path
    output_file = "/Users/sunghkim37/Library/CloudStorage/GoogleDrive-britkenko@gmail.com/My Drive/PACO/Gitpaco/tools/merged_extracted_conversations.md"
    ...
    merged_content.append("This document contains all extracted ChatGPT conversations from the Cortex-P-Rev repository.")
    merged_content.append("")
